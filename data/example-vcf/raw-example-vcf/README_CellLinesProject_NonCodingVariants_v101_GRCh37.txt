--------------------------------------
Cell Lines Project Non coding variants
--------------------------------------
 A tab separated table of all non-coding mutations from the current release. [ CellLinesProject_NonCodingVariants_v101_GRCh37.tsv.gz ]
  File Description
...
[5:E]                 COSMIC_SAMPLE_ID             A unique COSMIC sample identifier (COSS) is used to identify a sample. This identifier can be used to retrieve additional Sample information from the CellLinesProject_Sample file.
