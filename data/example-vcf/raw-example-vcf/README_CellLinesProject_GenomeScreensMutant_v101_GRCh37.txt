-------------------------------------------------
Cell Lines Project Mutation Data (Genome Screens)
-------------------------------------------------
 A tab separated table of coding point mutations from genome wide screens (including whole exome sequencing) from the current release. [ CellLinesProject_GenomeScreensMutant_v101_GRCh37.tsv.gz ]
...
[7:G]                 GENOMIC_MUTATION_ID          Genomic mutation identifier (COSV) to indicate the definitive position of the variant on the genome. This identifier is trackable and stable between different versions of the release. This identifier can be used to retrieve additional legacy mutation ids from the CellLinesProject_MutationTracking file.
...
[9:I]                 MUTATION_ID                  An internal mutation identifier to uniquely represent each mutation on a specific transcript on a given assembly build. This identifier can be used to retrieve additional legacy mutation ids from the CellLinesProject_MutationTracking file.
...
[27:AA]               CATALOGUE_NUMBER             Catalogue number of the cell line supplier.
[28:AB]               INSTITUTE                    Institute name of the cell line supplier.
[29:AC]               INSTITUTE_ADDRESS            Institute address of the cell line supplier.
